...
Makefile_Build = '''observers/{name}.adb: observers/{name}.pr
	...
	taste-asn1-gser --raw -o observers --module gser observer.asn observers/{name}_datamodel.asn
'''
...
def main():
    ...
    Makefile_String = Makefile.format(adb=Makefile_Adbs, build=Makefile_Builds)
