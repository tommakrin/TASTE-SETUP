...
#
# TASTE2.tcl: Tcl script for re-creating project 'TASTE2'
#
# Generated by Vivado on Mon Nov 25 17:21:27 GMT 2019
...
#
# 1. This project restoration tcl script (TASTE2.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/media/sf_C_DRIVE/Users/ViSOS/Desktop/TASTE/TASTE2/projects/TASTE2/TASTE2.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v"
#
# 3. The following remote source files that were added to the original project:-
#
#    "/media/sf_C_DRIVE/Users/ViSOS/Desktop/TASTE/TASTE2/src/TASTE2.xdc"
#
#*****************************************************************************************
...
set files [list \
 [file normalize "${origin_dir}/TASTE2.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]\
]
...
set file "[file normalize "$origin_dir/../../src/TASTE2.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../../src/TASTE2.xdc"
...
proc cr_bd_design_1 { parentCell } {
  ...
  # Create ports
  set done_led_0 [ create_bd_port -dir O done_led_0 ]
  set start_led_0 [ create_bd_port -dir O start_led_0 ]

  # Create instance: TASTE_0, and set properties
  set TASTE_0 [ create_bd_cell -type ip -vlnv user.org:user:TASTE:1.0 TASTE_0 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins TASTE_0/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net TASTE_0_done_led [get_bd_ports done_led_0] [get_bd_pins TASTE_0/done_led]
  connect_bd_net -net TASTE_0_start_led [get_bd_ports start_led_0] [get_bd_pins TASTE_0/start_led]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins TASTE_0/S_AXI_ACLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins TASTE_0/S_AXI_ARESETN] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs TASTE_0/S_AXI/reg0] SEG_TASTE_0_reg0
