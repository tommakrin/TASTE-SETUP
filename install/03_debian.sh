...
case "$VERSION" in
    ...
    *Ubuntu*18.04* )
        ...
        ;;
    *Ubuntu*20.04* )
        sudo apt-get install --no-install-recommends -y --force-yes evince gdebi wget autoconf automake curl universal-ctags gcc git gnat-10 gtkwave kate lcov libacl1 libacl1-dev libarchive-dev libattr1 libattr1-dev libdbd-sqlite3-perl libdbi-perl libfile-copy-recursive-perl libglib2.0-0 libgtk2-perl libgraphviz-dev libmono-system-data-linq4.0-cil libmono-system-numerics4.0-cil libmono-system-runtime-serialization-formatters-soap4.0-cil libmono-system-runtime4.0-cil libmono-system-web4.0-cil libmono-system-xml4.0-cil libmono-system4.0-cil libsqlite3-dev libtool libxml-libxml-perl libxml-libxml-simple-perl libxml-parser-perl libxml2-dev libxslt1-dev libzmq3-dev mono-mcs mono-runtime nedit net-tools python-coverage python-lxml python-pexpect expect python3-pip qemu-system sqlite3 sudo tk8.6 tree vim-gtk wmctrl xmldiff xterm xterm zip openjdk-11-jre python3-lxml bash-completion strace libusb-1.0-0-dev cmake dfu-util gnuplot libstdc++-8-dev python-mako gprbuild python3-singledispatch python3-stringtemplate3 python3-numpy python3-pygraphviz python3-sqlalchemy python3-ply python3-matplotlib python3-lxml python3-pexpect python3-psycopg2 python3-antlr python3-antlr3 python3-websocket python-setuptools make python3-setuptools g++ psmisc bsdmainutils gnat-gps python-is-python2 bzip2 unzip rsync libncurses5:i386 libgmp10:i386 qt5-default xdg-utils python3-mako python3-gi sqlitebrowser pypy3 || exit 1
